...
scoreboard objectives add vpStartingHouseType dummy
scoreboard objectives add kkmnPoisonCloudRadius dummy
scoreboard objectives add vpCopperSpikeDamageConstant2 dummy
scoreboard players set $OxidizedCopperSpike vpCopperSpikeDamageConstant2 2
scoreboard objectives add vpCopperSpikeFallingDistance dummy

team add NameHidden

data merge storage vanilla_plus:ench_levels {}
...
data merge storage vanilla_plus:falling_distance {}